...
export default function Form({ ticket }) {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    if (EditMode) {
      const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/tickets-api/${ticket._id}`, {
        method: "PUT",
        headers: {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/tickets-api`, {
        method: "POST",
        body: JSON.stringify({ formData }),
